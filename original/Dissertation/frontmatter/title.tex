...
{\HUGE Bayesian Linear Regression of Simulated Diffraction Measurements for Residual Stress Analysis
}\\[4mm]
{{\rule[0.5ex]{\linewidth}{2pt}\\
\vspace{6.5mm}
{\large By}\\
\vspace{6.5mm}
{\large\textsc{Farah Hassan}}\\
\vspace{11mm}
...
\vspace{11mm}
\begin{minipage}{10cm}
A thesis submitted to the University of Bristol in accordance with the requirements for the degree of \textsc{Masters in Nuclear Science and Engineering} in the School of Physics, Faculty of Science.
\end{minipage}\\
\vspace{9mm}
