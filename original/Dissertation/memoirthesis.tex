...
\documentclass[oneside,a4paper,11pt,leqno,openbib,oldfontcommands]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
\usepackage{datetime}
...
\import{chapters/chapter005/}{chapter005.tex}
\clearemptydoublepage
